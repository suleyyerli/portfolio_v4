    ...
    <div>
      ...
      <div className="mt-4">
        ...
        <p>
          ...
          d&apos;informatique. Mon parcours m&apos;a permis de combiner théorie
          et expérience professionnelle, avec des projets concrets en
      ...
      <div className="mt-4">
        ...
        <ul>
          <li>
            <p>
              <span className="font-mplus-rounded font-bold">2001 :</span> Né à
              Strasbourg
            </p>
          </li>
          ...
          <li>
            <p>
              <span className="font-mplus-rounded font-bold">2022-2023 :</span>{" "}
